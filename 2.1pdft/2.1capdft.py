...
Al    D
      0.3250000              1.0000000''')
#ref pbe calculation for O2/Al50 at 2.1A
# OLD reference (commented out): unsmeared DFT from al2.1.chk
#mol, scf_dict = scfchk.load_scf('al2.1.chk')
#mf = dft.UKS(mol)
#mo_coeff  = scf_dict['mo_coeff']
#mo_occ    = scf_dict['mo_occ']
#mo_energy = scf_dict['mo_energy']
#Daref, Dbref = mf.make_rdm1(mo_coeff, mo_occ)
# NEW reference: smeared (sigma=0.002) restart full-system spin DMs from 2.1dftref
with open("../2.1dftref/al2.1_sigma0.002_restart_last_dm.pkl", "rb") as f:
